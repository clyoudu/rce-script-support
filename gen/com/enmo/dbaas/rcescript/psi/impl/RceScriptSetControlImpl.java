...
public class RceScriptSetControlImpl extends ASTWrapperPsiElement implements RceScriptSetControl {

  public RceScriptSetControlImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RceScriptVisitor visitor) {
    visitor.visitSetControl(this);
  }
