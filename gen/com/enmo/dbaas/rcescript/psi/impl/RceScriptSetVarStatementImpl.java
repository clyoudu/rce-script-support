...
public class RceScriptSetVarStatementImpl extends ASTWrapperPsiElement implements RceScriptSetVarStatement {

  public RceScriptSetVarStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RceScriptVisitor visitor) {
    visitor.visitSetVarStatement(this);
  }
